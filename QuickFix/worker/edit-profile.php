...
<div style="margin-top:40px;"class="container jumbotron">
  ...
  <form method="post"action="../php/update_worker.php">
    <?php require('../php/connect.php');
      $uid=$_SESSION['user'];
      $query = "SELECT * FROM worker WHERE worker_id=$uid";
  ...
  <div class="form-group ">
    ...
    <select name="work" id="inputState" class="form-control" required value="<?php echo $row['work']?>">
