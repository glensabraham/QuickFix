...
<div class="container">
  ...
  <?php
          ...
          $id=$_SESSION['user'];
          $query1 = "SELECT * FROM on_deal WHERE user_id=$id and status='pending'" ;
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a class="btn btn-primary" href="contact_worker.php?id=<?php echo $deal_id;?>&job=<?php echo $jid;?>&worker=<?php echo $worker_id;?>">Contact worker</a>
        <a class="btn btn-outline-primary" href="../php/job_status.php?id=<?php echo $row['job_id']?>&status=completed"> Completed</a>
